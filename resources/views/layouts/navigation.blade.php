        ...
        <div class="flex justify-between h-16">
            <div class="flex">
               ...
               @if(auth()->user()->type==1)
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('donorrequest.index')" :active="request()->routeIs('donorrequest.index')">
                        {{ __('Donor List') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('recipientrequest.index')" :active="request()->routeIs('recipientrequest.index')">
                        {{ __('Recipient List') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
