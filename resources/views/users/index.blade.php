<x-app-layout>
    ...
    <div class="py-12 px-20">
        ...
        margin-bottom:20px;
        margin-right:13vw;">
            <a href="{{route('users.create')}}" class="btn-primary inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150 flex justify-self-end">Create user</a>
        </div>
        ...
        <table class="min-w-full divide-y divide-gray-200 w-100 mx-auto">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                @empty
                    <tr><td colspan="5" class="px-6 py-4 ">No user to display</td></tr>
                @endforelse
            </tbody>
        </table>
